...
let content2 = fs.readFileSync("./contracts/PlonkMultiplier3Verifier.sol", { encoding: 'utf-8' });
let bumped2 = content2.replace(solidityRegex, 'pragma solidity ^0.8.0');
bumped2 = bumped2.replace(verifierRegex, 'contract PlonkMultiplier3Verifier');

fs.writeFileSync("./contracts/PlonkMultiplier3Verifier.sol", bumped2);