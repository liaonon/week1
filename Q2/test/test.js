...
describe("Multiplier3 with PLONK", function () {
    ...
    it("Should return true for correct proof", async function () {
        //[assignment] insert your script here
        const { proof, publicSignals } = await plonk.fullProve({"a":"3","b":"4","c":"5"}, "contracts/circuits/PlonkMultiplier3/Multiplier3_js/Multiplier3.wasm","contracts/circuits/PlonkMultiplier3/circuit_final.zkey");
